...
(* Typed o G rs e t i ->
  ...
  ~ bv_term e x ->
  ~ bv_term e y ->
  Typed o G rs (subst_var e x y) t i. fold hese together. one branch says (forall G', CtxSubst x y G G' -> ...,), the othe rsays  (~fv e y -> ...)
 *)
...
Proof.
  ...
  - edestruct (H x0 y). admit. admit. best. best.
    edestruct (H0 x0 y). admit. admit. best. best.
    admit.
